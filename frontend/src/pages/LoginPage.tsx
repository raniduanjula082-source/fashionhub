...
export function LoginPage() {
    ...
    const handleSocialLogin = async (provider: string) => {
        try {
            ...
            console.error(error);
            alert(`${provider} login failed. Please try standard sign in.`);
        }
    };
                ...
                <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <a href="#" className="text-sm text-[#1a3a6b] hover:underline font-medium">
                                Forgot password?
                            </a>
                        </div>
                    ...
                    <p className="mt-6 text-center text-sm text-gray-600">
                        ...
                        <a href="#" onClick={(e) => { e.preventDefault(); window.location.hash = 'signup'; }} className="text-[#1a3a6b] font-medium hover:underline">
                            Sign up
                        </a>
                    </p>
                </div>
